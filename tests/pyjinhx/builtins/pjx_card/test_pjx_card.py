...
class CardHost(BaseComponent):
    ...
    never iterates a list (confirmed against tests/pyjinhx/test_slot_collections.py's
    ...
    `Panel` in tests/pyjinhx/builtins/test_family_display_primitives_sweep.py.
    """
