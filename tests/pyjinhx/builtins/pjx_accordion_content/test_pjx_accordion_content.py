...
def test_extra_attrs_surface_on_the_root(content_session):
    html = _html(content_session, extra_attrs={"data-testid": "content"})
    assert 'data-testid="content"' in html[: html.index(">")]
