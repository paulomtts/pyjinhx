...
DEFAULT_RUNTIME_URL = "/static/pyjinhx_v0/pjx.js"
DEFAULT_HTMX_URL = "/static/pyjinhx_v0/htmx.min.js"
...
class RenderSession:
    ...
    Attributes:
        ...
        runtime_injected: Whether the pyjinhx_v0 client runtime was scheduled.
...
def runtime_asset_path() -> str:
    """Return the absolute path to the bundled pyjinhx_v0 client runtime."""
...
def resolver_with_hash(base_url: str, root: str) -> AssetUrlResolver:
    ...
    def resolve(path: str) -> str:
        ...
        if normalized_path == os.path.normpath(runtime_asset_path()):
            ...
            return f"{base_url.rstrip('/')}/pyjinhx_v0/{hashed}"
...
def inject_runtime(
    ...
    *,
    ...
    from pyjinhx_v0.client import MountedManifest
...
def inject_assets(
    ...
    *,
    ...
    from pyjinhx_v0.client import ClientBackend, LoadedAssets, MountedManifest
