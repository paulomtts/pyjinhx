...
from pyjinhx_v0.dev import disable_reactive_dev, enable_reactive_dev
...
def configure_pyjinhx(
    ...
    **kwargs: Any,
    ...
    from pyjinhx_v0.assets import set_inject_htmx
...
def setup(
    ...
    **kwargs: Any,
    ...
    """
    Wire pyjinhx_v0 for this process (and optionally a web app).
    ...
    pyjinhx_v0 runtime on reactive root renders, so reactivity works out of the
    ...
    from pyjinhx_v0.integrations.fastapi import apply_setup
