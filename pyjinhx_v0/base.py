...
def validate_extra_attrs(value: dict[str, str]) -> dict[str, str]:
    ...
    (see ``pyjinhx_v0.root_attrs``). Values with both are inexpressible.
    """
...
def collect_extra_attrs(component: "BaseComponent") -> dict[str, str]:
    ...
    handling happen at injection time (see ``pyjinhx_v0.root_attrs``).
    """
...
class BaseComponent(BaseModel):
    ...
    def render(self) -> Markup:
        ...
        """
        from pyjinhx_v0.reactive import _finish_with_oob
